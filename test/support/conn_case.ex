defmodule MindariWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = Mindari.AccountsFixtures.user_fixture()
    scope = Mindari.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Mindari.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Mindari.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
