defmodule Mindari.ObsidianTest do
  ...
  describe "markdown_to_html/1 link support" do
    test "converts external links [text](url) to HTML with new tab and symbol" do
      ...
      expected =
        "<p class=\"text-gray-300 mb-4 leading-relaxed\">Check out <a href=\"https://google.com\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-400 hover:text-blue-300 underline\">Google <span class=\"text-xs\">↗</span></a> for search.</p>"
    ...
    test "handles links with special characters" do
      ...
      expected =
        "<p class=\"text-gray-300 mb-4 leading-relaxed\">Visit <a href=\"https://example.com?q=test&amp;r=1\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-400 hover:text-blue-300 underline\">Site with &amp; symbols <span class=\"text-xs\">↗</span></a>.</p>"
